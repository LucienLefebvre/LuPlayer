...
/**
    ...
    @tags{Audio}
*/
class GainThumbnail  : public juce::AudioThumbnailBase
{
public:
    //==============================================================================
    ...
    */
    GainThumbnail(int sourceSamplesPerThumbnailSample,
        juce::AudioFormatManager& formatManagerToUse,
        juce::AudioThumbnailCache& cacheToUse);

    /** Destructor. */
    ~GainThumbnail() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (GainThumbnail)
};
