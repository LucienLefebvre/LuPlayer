...
//==============================================================================
Settings::Settings(int ouputChannelsAvalaible) : settingsFile(options)
{
    ...
    outputChannels = ouputChannelsAvalaible;
    ...
    convertedSoundsButtons.setBounds(0, 300, 200, 25);
    ...
    audioOutputModeListbox.setBounds(200, 350, 400, 25);
