...
//midi quand on débranche puis rebranche
// position cue fin quand son < 6s
// changer emplacement de base par bureau
// déplacement waveform cart bug à gauche
// enlever mode 4 canaux quand on change de audio device
//==============================================================================
