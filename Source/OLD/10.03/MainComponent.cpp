...
//ajouter conditions pour glisser / déposer en cours de lecture
//==============================================================================
...
bool MainComponent::isDraggable(int playlistSource, int playerSource, int playlistDestination, int playerDestination)
{
   ...
   /* if (playlistSource == playlistDestination)
    {
        if ((playerSource > std::max(myPlaylists[playlistSource]->fader1Player, myPlaylists[playlistSource]->fader2Player))
            && (playerDestination > std::max(myPlaylists[playlistSource]->fader1Player, myPlaylists[playlistSource]->fader2Player)))
        {
            DBG("true");
            return true;
        }
