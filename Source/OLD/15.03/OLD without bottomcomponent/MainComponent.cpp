...
void MainComponent::paint(juce::Graphics& g)
{
    ...
    else if (Settings::audioOutputMode == 1)
    {
      ...
      /*  shortTermLoudness = shortTermLoudness - 3.0;
        if (shortTermLoudness < -300.0)
            shortTermLoudness = -300.0;*/
    }
    ...
    if (shortTermLoudness >= -23.)
    {
        ...
        int loudnessMeterHeightMinusEighteen = minusTwentyThreeDbLoudness * (levelMeterHeight - meterNumericDisplayHeight - 15);
        g.setColour(juce::Colour(40, 134, 189));
