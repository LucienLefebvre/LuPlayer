...
//==============================================================================
//lancement rec n'ouvre pas le bon composant
// mark dans le recorder décallées
// lancement rec par v -> faire qu'il s'arrête au point de sortie
//resampling barre du bas
