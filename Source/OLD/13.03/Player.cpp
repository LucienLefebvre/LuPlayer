...

{
   ...
   /* int playerPosition = playerIndex + 1;
    ...
    if (isCart == true)
    {
        waveformThumbnailXSize = getParentWidth() - leftControlsWidth - rightControlsWidth - borderRectangleWidth * 2 - volumeSliderWidth - 2 * cartButtonsControlWidth - 20 - dragZoneWidth;
...
void Player::paint (juce::Graphics& g)
{
    ...
    */
    ...
    {//rectangle Fader1
        ...
        {//rectangle Fader2
            int x = getParentWidth() - borderRectangleWidth - playlistButtonsControlWidth - dragZoneWidth, y = 0, width = borderRectangleWidth, height = borderRectangleHeight;
...
void Player::resized()
{
    ...
    if (isCart == true)
    {
        waveformThumbnailXSize = getParentWidth() - leftControlsWidth - rightControlsWidth - volumeSliderWidth - 2*cartButtonsControlWidth - dragZoneWidth;
        waveformThumbnailXEnd = waveformThumbnailXStart + waveformThumbnailXSize;
        trimVolumeSlider.setBounds(0 - 8, 40, 64, 56);
