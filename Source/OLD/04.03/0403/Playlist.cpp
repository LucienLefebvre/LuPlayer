...
void Playlist::addPlayer(int playerID)
{
   ...
   /* if (playlistType == 1)
        players[idAddedPlayer]->setBounds(assignFaderButtonWidth, playersStartHeightPosition + (idAddedPlayer * (playerHeight + spaceBetweenPlayer)), (assignFaderButtonWidth * 2) - dragZoneWidth, playerHeight);
    else if (playlistType == 0)
        players[idAddedPlayer]->setBounds(dragZoneWidth, playersStartHeightPosition + (idAddedPlayer * (playerHeight + spaceBetweenPlayer)), controlButtonXStart - dragZoneWidth, playerHeight);*/
    if (playlistType == 0)
    {
