...
//==============================================================================
//on perde le triage quand on clique sur refresh
//database import : la séléction ne change pas quand on clique sur la cellule du nom
//récupérer nom pc pour requête sql
